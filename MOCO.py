...
"""
Adapt from: https://github.com/facebookresearch/moco
@Article{he2019moco,
...
# add more argument fo
parser.add_argument('-a', '--arch', metavar='ARCH', default='./model',
                    help='model names')
...
#         raise NotImplementedError("Only DistributedDataParallel is supported.")
    ...
    with open(args.data, 'r', encoding='utf-8') as f:
        ...
        for row in reader:
            ...
            mask = torch.cat(
                (pos_dict1['attention_mask'], pos_dict2['attention_mask']), dim=0)
...
def train(train_loader, model, criterion, optimizer, epoch, args, losslist):
    ...
    for i, (sens, masks) in enumerate(train_loader):
        ...
        # the part below adapt image classification to sentencce classification
        # therefore this part is different from original MOCO code
