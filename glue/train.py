...
from runners import GlueTaskRunner, RunnerParameters
...
def main():
    ...
    tokenizer = shared_model_setup.create_tokenizer(
        ...
        xlnet_vocab_path=args.xlnet_vocab_path,
    )
    all_state = shared_model_setup.load_overall_state(args.xlnet_load_path, relaxed=True)
